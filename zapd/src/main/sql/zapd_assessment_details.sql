...
CREATE TABLE `assessment_details` (
  `ID` int(11) NOT NULL,
  `CAUSEOFDISABILITY` varchar(255) DEFAULT NULL,
  `DATEOFASSESSMENT` datetime DEFAULT NULL,
  `DATEOFDISABILITY` datetime DEFAULT NULL,
  `REGISTRATIONDATE` datetime DEFAULT NULL,
  `STATUS` varchar(255) DEFAULT NULL,
  `ASSESSOR` int(11) DEFAULT NULL,
  `DMISNUMBER` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_assessment_details_DMISNUMBER` (`DMISNUMBER`),
  KEY `FK_assessment_details_ASSESSOR` (`ASSESSOR`)
...
-- Dump completed on 2017-02-05 20:31:42
